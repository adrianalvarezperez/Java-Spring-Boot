			...
			<ul class="navbar-nav">
				<sec:authorize access="hasAuthority('ROLE_ADMIN')">
					<li class="nav-item active"><a class="nav-link"
						href="/app/tipos/todos">Tipos</a></li>
				</sec:authorize>
				<li class="nav-item"><a class="nav-link" href="/">Productos</a>
				</li>
				<sec:authorize access="hasAnyAuthority('ROLE_ADMIN')">
					<li class="nav-item"><a class="nav-link"
						href="/app/usuarios/todos">Usuarios</a></li>
				</sec:authorize>
				<sec:authorize access="hasAuthority('ROLE_ADMIN')">
					<li class="nav-item"><a class="nav-link"
						href="/app/perfiles/todos">Perfiles</a></li>
				...
				<sec:authorize access="isAuthenticated()">
					<li class="nav-item"><a class="nav-link"
						href="/cliente/cuenta">Mi Cuenta</a></li>
					<li class="nav-item"><a class="nav-link"
						href="/cliente/pedidos">Mis Pedidos</a></li>

				</sec:authorize>
				<li class="nav-item"><a class="nav-link" href="/cesta/ver">Ver
						Cesta</a></li>
			</ul>
		</div>
	</nav>
